...
do 
    python3 main.py \
        ...
        --doremi \
        --doremi_mu 0.01 \
        --doremi_reference_model_path ./saved_models/slimpj_pythia-160m_from_scratch_5000_mixture_arxiv_stackexchange_weights_55_static_lr_0.0005_linear_warmup_cosine_seed_${SEED}.pt \
